package com.danish.frontend.factories; // Ganti dengan nama package kalian
import java.util.*;
...
public class ObstacleFactory {
    ...
    public interface ObstacleCreator {
        ...
        // TODO: Deklarasikan abstract method release() untuk me-releaseBaseObstacle ke pool.
        // Menerima BaseObstacle.
        void release(BaseObstacle obstacle);

        // TODO: Deklarasikan abstract method releaseAll() untuk me-releasesemua objek aktif.
        // Tidak menerima apapun.
        void releaseAll();

        // TODO: Deklarasikan abstract method getInUse() untuk mendapatkanlist objek yang sedang digunakan.
        // Mengembalikan List<? extends BaseObstacle>.
        // Tidak menerima apapun.
        List<? extends BaseObstacle> getInUse();

        // TODO: Deklarasikan abstract method supports() untuk mengecekapakah creator ini mendukung tipe BaseObstacle yang diberikan.
        // Mengembalikan boolean.
        // Menerima BaseObstacle.
        boolean supports(BaseObstacle obstacle);

        // TODO: Deklarasikan abstract method getName() untuk mendapatkannama creator.
